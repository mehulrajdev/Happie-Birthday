      ...
      function t(i) {
        return this instanceof t
          ? ((r = this),
            ...
            (r.serial = 1),
            (r.blocked = !1),
            (r.config = o(r.defaults, i)),
            (r.isMobile() && !r.config.mobile) || !r.isSupported()
              ? void r.destroy()
              : (r.config.viewport === e.document.documentElement
                  ? (e.addEventListener("scroll", a, !1),
                    e.addEventListener("resize", a, !1))
                  : r.config.viewport.addEventListener("scroll", a, !1),
                void r.init(!0)))
          : new t(i);
      }
      var i, o, a, r;
        ...
        (t.prototype = {
          ...
          init: function (e) {
            ...
            (o = Array.prototype.slice.call(
              r.config.viewport.querySelectorAll("[data-sr]")
            )),
          ...
          animate: function (e) {
            ...
            var i, o, a;
            for (i in r.elems)
              r.elems.hasOwnProperty(i) &&
                ((o = r.elems[i]),
                (a = r.isElemInViewport(o)),
                a
                  ? ("always" === r.config.delay ||
                    ("onload" === r.config.delay && e) ||
                    ("once" === r.config.delay && !o.seen)
                      ? o.domEl.setAttribute(
                          "style",
                          o.styles.inline +
                            o.styles.target +
                            o.styles.transition
                      ...
                      : o.domEl.setAttribute(
                          "style",
                          o.styles.inline + o.styles.target + o.styles.reset
                        ),
                    (o.seen = !0),
                    o.config.reset || o.animating || ((o.animating = !0), t(i)))
                  : !a &&
                    o.config.reset &&
                    o.domEl.setAttribute(
                      "style",
                      o.styles.inline + o.styles.initial + o.styles.reset
                    ));
            r.blocked = !1;
          },
          configFactory: function (e) {
            ...
            return (
              ...
              (i = o(i, r.config)),
              (i = o(i, t)),
              "top" === i.enter || "bottom" === i.enter
                ? (i.axis = "Y")
                : ("left" === i.enter || "right" === i.enter) && (i.axis = "X"),
              ("top" === i.enter || "left" === i.enter) &&
                (i.move = "-" + i.move),
              i
            );
          },
          styleFactory: function (e) {
            function t() {
              0 !== parseInt(s.move) &&
                ((o += " translate" + s.axis + "(" + s.move + ")"),
                (r += " translate" + s.axis + "(0)")),
                0 !== parseInt(s.scale.power) &&
                  ("up" === s.scale.direction
                    ? (s.scale.value = 1 - 0.01 * parseFloat(s.scale.power))
                    : "down" === s.scale.direction &&
                      (s.scale.value = 1 + 0.01 * parseFloat(s.scale.power)),
                  (o += " scale(" + s.scale.value + ")"),
                  (r += " scale(1)")),
                s.rotate.x &&
                  ((o += " rotateX(" + s.rotate.x + ")"), (r += " rotateX(0)")),
                s.rotate.y &&
                  ((o += " rotateY(" + s.rotate.y + ")"), (r += " rotateY(0)")),
                s.rotate.z &&
                  ((o += " rotateZ(" + s.rotate.z + ")"), (r += " rotateZ(0)")),
                (o += "; opacity: " + s.opacity + "; "),
                (r += "; opacity: 1; ");
            }
            var i,
            ...
            return (
              (i = e.domEl.getAttribute("style")
                ? e.domEl.getAttribute("style") + "; visibility: visible; "
                : "visibility: visible; "),
              (n =
          ...
          getViewportH: function () {
            var t = r.config.viewport.clientHeight,
              i = e.innerHeight;
            return r.config.viewport === e.document.documentElement && i > t
              ? i
              : t;
          },
          scrollY: function () {
            return r.config.viewport === e.document.documentElement
              ? e.pageYOffset
              : r.config.viewport.scrollTop + r.config.viewport.offsetTop;
          },
          ...
          isSupported: function () {
            for (
              var e = document.createElement("sensor"),
                t = "Webkit,Moz,O,".split(","),
                i = ("transition " + t.join("transition,")).split(","),
                o = 0;
              o < i.length;
              o++
            )
